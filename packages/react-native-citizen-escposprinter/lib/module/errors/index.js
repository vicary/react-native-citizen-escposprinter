...
export class ConnectNotFound extends PrinterError {
  constructor() {
    super(ESCPOSConst.CMP_E_CONNECT_NOTFOUND, "Failed to check the support model after connecting to the device.");
  }
}
export class ConnectOffline extends PrinterError {
  constructor() {
    super(ESCPOSConst.CMP_E_CONNECT_OFFLINE, "Failed to check the printer status after connecting to the device.");
  }
}
...
export class BluetoothDisable extends PrinterError {
  constructor() {
    super(ESCPOSConst.CMP_E_BT_DISABLE, "The setting of the Bluetooth device is invalid.");
  }
}
...
export class Illegal extends PrinterError {
  constructor() {
    super(ESCPOSConst.CMP_E_ILLEGAL, "Unsupported operation with the Device, or an invalid parameter value was used.");
  }
}
...
export class Failure extends PrinterError {
  constructor() {
    super(ESCPOSConst.CMP_E_FAILURE, "The Service cannot perform the requested procedure.");
  }
}
export class Timeout extends PrinterError {
  constructor() {
    super(ESCPOSConst.CMP_E_TIMEOUT, "The Service timed out waiting for a response from the printer.");
  }
}
export class NoList extends PrinterError {
  constructor() {
    super(ESCPOSConst.CMP_E_NO_LIST, "The printer cannot be found in the printer search.");
  }
}
...
export class BadFormat extends PrinterError {
  constructor() {
    super(ESCPOSConst.CMP_EPTR_BADFORMAT, "The specified file is in an unsupported format.");
  }
}
...
export const getPrintError = code => {
  switch (code) {
